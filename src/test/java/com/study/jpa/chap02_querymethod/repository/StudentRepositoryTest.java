...
class StudentRepositoryTest {
    ...
    // @BeforeAll : 해당 테스트 클래스를 초기화할 때 딱 한번 수행하는 메서드 (static 선언 해야함)
//    @BeforeEach // 각각의 테스트 메서드 실행 직전에 수행하는 메서드
//    void insertData() {
...
//    }
    ...
    @Test
    @DisplayName("이름이 춘식이인 학생의 정보를 구해야 한다")
    void testFindByName() {
        // given
        String name = "춘식이";
        // when
